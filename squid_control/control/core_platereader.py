    ...
    def run_single_time_point(self):
        ...
        for column in self.selected_columns:
            ...
            for row in range(CONFIG.PLATE_READER.NUMBER_OF_ROWS):
                ...
                # CONFIG.AF
                if (self.NZ == 1) and (self.do_autofocus) and (self.FOV_counter%CONFIG.Acquisition.NUMBER_OF_FOVS_PER_AF==0):
                ...
                for k in range(self.NZ):
                    ...
                    for config in self.selected_configurations:
                        ...
                        saving_path = os.path.join(current_path, file_ID + '_' + str(config.name) + '.' + CONFIG.Acquisition.IMAGE_FORMAT)
...
class PlateReadingController(QObject):
    ...
    def __init__(self,camera,plateReaderNavigationController,liveController,autofocusController,configurationManager):
        ...
        self.NZ = 1
        self.Nt = 1
        mm_per_ustep_X = CONFIG.SCREW_PITCH_X_MM/(self.plateReaderNavigationController.x_microstepping*CONFIG.FULLSTEPS_PER_REV_X)
        mm_per_ustep_Y = CONFIG.SCREW_PITCH_Y_MM/(self.plateReaderNavigationController.y_microstepping*CONFIG.FULLSTEPS_PER_REV_Y)
        mm_per_ustep_Z = CONFIG.SCREW_PITCH_Z_MM/(self.plateReaderNavigationController.z_microstepping*CONFIG.FULLSTEPS_PER_REV_Z)

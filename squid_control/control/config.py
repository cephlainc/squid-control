...
class BaseConfig(BaseModel):
    ...
    CAMERA_PIXEL_SIZE_UM:dict = {'IMX290':2.9,'IMX178':2.4,'IMX226':1.85,'IMX250':3.45,'IMX252':3.45,'IMX273':3.45,'IMX264':3.45,'IMX265':3.45,'IMX571':3.76,'PYTHON300':4.8}
    OBJECTIVES:dict = {'2x':{'magnification':2, 'NA':0.10, 'tube_lens_f_mm':180}, 
    ...
    TRACKERS:List[str] = ['csrt', 'kcf', 'mil', 'tld', 'medianflow','mosse','daSiamRPN']
    DEFAULT_TRACKER: str = 'csrt'

    ENABLE_TRACKING:bool = False
    TRACKING_SHOW_MICROSCOPE_CONFIGURATIONS:bool = False # set to true when doing multimodal acquisition
    ...
    CAMERA_SN:dict = {'ch 1':'SN1','ch 2': 'SN2'} # for multiple cameras, to be overwritten in the configuration file
    ...
    FOCUS_MEASURE_OPERATOR:str = 'LAPE' # 'GLVA' # LAPE has worked well for bright field images; GLVA works well for darkfield/fluorescence
    ...
    SEGMENTATION_MODEL_PATH: str = "/home/cephla/Documents/tmp/model_segmentation_1073_9.pth"

...
class StreamHandler(QObject):
    ...
    def __init__(self,crop_width=CONFIG.Acquisition.CROP_WIDTH,crop_height=CONFIG.Acquisition.CROP_HEIGHT,display_resolution_scaling=0.5):
    ...
    def on_new_frame(self, camera):
        ...
        self.packet_image_for_array_display.emit(image_cropped,(camera.frame_ID - camera.frame_ID_offset_hardware_trigger - 1) % CONFIG.VOLUMETRIC_IMAGING.NUM_PLANES_PER_VOLUME)
